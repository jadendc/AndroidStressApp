...
class SOTDWork : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toggleColleagues = findViewById<ToggleButton>(R.id.button)
        val toggleBoss = findViewById<ToggleButton>(R.id.button6)
        val toggleEmployees = findViewById<ToggleButton>(R.id.button7)
        val toggleWorkload = findViewById<ToggleButton>(R.id.button8)
    ...
    private fun getSelectedStressor(customText: String): String {
        ...
        val toggleLabels = listOf("Colleagues", "Boss", "Employees", "Workload", "Time Management", "Work Culture")
    ...
    private fun saveSOTDWorkToFirestor() {
