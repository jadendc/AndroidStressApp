...
class ForestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_forest) // XML layout for ForestActivity

        // Get number of cycles from Intent
        val cycles = intent.getIntExtra("selectedCycles", 1)

        // Initialize MediaPlayer for Forest sound
        mediaPlayer = MediaPlayer.create(this, R.raw.forestsound) // Replace with the correct sound file
    ...
    private fun setupBreathCycleAnimation(cycles: Int) {
        ...
        hollowSquare.post {
            ...
            animator.duration = 160000 // Duration per full cycle (adjustable)
