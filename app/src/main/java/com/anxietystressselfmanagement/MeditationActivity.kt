...
class MeditationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_meditation) // XML layout for MeditationActivity
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.meditationmusic) // Replace with the correct sound file
        ...
        // Start the hollow square animation for breathing cycles
    ...
    private fun setupBreathCycleAnimation(cycles: Int) {
        ...
        hollowSquare.post {
            ...
            animator.duration = 16000 // Duration per full cycle
            animator.repeatCount = cycles - 1 // Repeat based on selected cycles
