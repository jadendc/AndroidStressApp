...
class FireActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (exerciseType == null) {
            Log.e("FireActivity", "Exercise type is missing. Intent extras: ${intent.extras}")
            Toast.makeText(this, "An error occurred. Please restart the app.", Toast.LENGTH_SHORT).show()
            finish()
            return
        }
        Log.d("FireActivity", "Received exerciseType: $exerciseType")
        ...
        // Display the Fire GIF as background
        val backgroundGifView: ImageView = findViewById(R.id.backgroundGif)
        Glide.with(this)
            .asGif()
            .load(R.raw.firegif) // Replace with Fire GIF resource
    ...
    private fun getGifResource(exerciseType: String): Int {
        return when (exerciseType) {
            ...
            else -> R.raw.firegif // Default GIF for FireActivity
        }
    }
