...
class FireActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fire) // XML layout for FireActivity

        // Get number of cycles from Intent
        val cycles = intent.getIntExtra("selectedCycles", 1)

        // Initialize MediaPlayer for Fire sound
        mediaPlayer = MediaPlayer.create(this, R.raw.firesound) // Replace with the correct sound file
    ...
    private fun setupBreathCycleAnimation(cycles: Int) {
        ...
        hollowSquare.post {
            ...
            animator.duration = 16000 // Duration per full cycle (adjustable)
